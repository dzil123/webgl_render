...
const programSim = await webgl.loadProgram(gl, ["fullscreen_tri.vert", "sandSim.frag"], ["bw", "buffer"]);
const programRender = await webgl.loadProgram(gl, ["fullscreen_tri.vert", "sandRender.frag"], ["buffer"]);
